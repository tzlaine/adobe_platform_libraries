...
// TODO: Basically everything in this file needs attention for a new platform to work.
...
bool get_font(int widget_type, int/*LOGFONTW*/& out_font);
...
bool get_font_metrics(int widget_type, int/*TEXTMETRIC*/& out_metrics);
...
bool get_text_extents(int widget_type, std::string text, int/*RECT*/& out_extents, const int/*RECT*/* in_extents = NULL);
...
bool get_size(int widget_type, int/*THEMESIZE*/ measurement, int/*SIZE*/& out_size);
...
bool get_margins(int widget_type, int/*MARGINS*/& out_margins);
...
void draw_parent_background(platform_display_type window, int/*HDC*/ dc);
...
void set_theme_name(char const * /* const WCHAR* */ theme_name);
