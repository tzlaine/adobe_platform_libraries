...
bool get_text_extents(int widget_type, std::string text, int/*RECT*/& out_extents, const int/*RECT*/* in_extents)
{
    /* TODO
    if (using_styles())
    {
