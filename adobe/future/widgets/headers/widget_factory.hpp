...
inline sheet_t::monitor_value_t obtain_set_cell_from_controller_proc(sheet_t& sheet, name_t cell)
{
...
/*!
    ...
    broadcast to is sent in to the splitter_controller_adaptor as an array.
*/
template <typename ModelType>
...
void attach_enabler(assemblage_t& assemblage, name_t cell, Controller& control, sheet_t& sheet,
                    const dictionary_t& parameters)
{
